...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    searchTerms: 'pdf merge combine join multiple files',
  },
  {
    id: 'pdf-split',
    name: 'Split PDF',
    ...
    searchTerms: 'pdf split extract pages separate',
  },
  {
    id: 'compress-pdf',
    name: 'Compress PDF',
    ...
    icon: '🗜️',
    href: '#',
    searchTerms: 'pdf compress reduce size optimize',
    upcoming: true,
  },
  {
    id: 'pdf-to-word',
    ...
    icon: '📝',
    href: '#',
    searchTerms: 'pdf word docx convert editable',
    upcoming: true,
  },
  {
    id: 'word-to-pdf',
    ...
    icon: '📄',
    href: '#',
    searchTerms: 'word pdf docx convert',
    upcoming: true,
  },
  {
    id: 'epub-to-pdf',
    ...
    icon: '📚',
    href: '#',
    searchTerms: 'epub pdf ebook convert',
    upcoming: true,
  },
  {
    id: 'unlock-pdf',
    ...
    icon: '🔓',
    href: '#',
    searchTerms: 'pdf unlock password remove protection',
    upcoming: true,
  },
  {
    id: 'protect-pdf',
    ...
    icon: '🔒',
    href: '#',
    searchTerms: 'pdf protect password secure lock',
    upcoming: true,
  },
  {
    id: 'watermark-pdf',
    ...
    icon: '💧',
    href: '#',
    searchTerms: 'pdf watermark add text image brand',
    upcoming: true,
  },
  {
    id: 'picker-wheel',
    name: 'Picker Wheel',
    description: 'Random picker and decision maker',
    icon: '🎯',
    href: '#',
    searchTerms: 'picker wheel random decision maker choose',
    upcoming: true,
  },
  {
    id: 'age-calculator',
    ...
    icon: '📅',
    href: '#',
    searchTerms: 'age calculator birthdate years old',
    upcoming: true,
  },
