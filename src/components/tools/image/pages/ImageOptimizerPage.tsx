      ...
      <Container>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-muted max-w-2xl mx-auto">
            Compress and reduce image file size while maintaining visual quality. Powered by Web Workers for fast processing.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          {selectedFile && previewUrl && (
            <div className="space-y-6">
              ...
              <OptimizeTab selectedFile={selectedFile} formatSize={formatSize} onFullReset={reset} />
            </div>
          )}
        </div>
